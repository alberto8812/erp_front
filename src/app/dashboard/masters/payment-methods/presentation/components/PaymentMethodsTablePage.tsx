...
import { columnsPaymentMethods } from "./columns-payment-method";
import { paymentMethodFormConfig } from "../forms/payment-method-form.config";
...
export function PaymentMethodsTablePage() {
  const {
    data,
    isLoading,
    pagination,
  ...
  return (
    <>
      <PageHeader pageHeader={paymentMethodsHeader} />

      <Show
        when={!isLoading}
        fallback={<TableSkeleton columns={columnsPaymentMethods.length} />}
      >
        <MainDataTable
      ...
      <CrudFormDialog
        ...
        title={editingItem ? "Editar Método de Pago" : "Crear Método de Pago"}
      ...
      <ExcelImportDialog
        ...
        title="Importar Métodos de Pago desde Excel"
